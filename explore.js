(() => {
  ...
  const cfg = {
    ...
    ai: {
      ...
      eyebrow: "ASK AI",
      title: "Ask AI",
      subtitle: "Search with Google and explore the results right here.",
      placeholder: "Search anything you want to know…",
      loading: "Searching…",
      button: "Search",
    ...
    break: {
      ...
      title: "Take a Break",
      subtitle: "Search pictures and explore them right here.",
