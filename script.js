/* Self-contained Logos 2026 data: keeps the Bible study panel working even if a separate data asset is cached or unavailable. */
window.LOGOS_DEEP_2026={
ruth:{label:"🌾 Ruth",range:[1,4],chapters:{
1:{title:"Naomi and Ruth return to Bethlehem",facts:["A famine occurs in Bethlehem.","Elimelech takes Naomi and their two sons to Moab.","Elimelech dies in Moab.","Naomi's sons marry Ruth and Orpah.","Both of Naomi's sons die.","Naomi hears that the Lord has provided food for his people in Bethlehem.","Orpah returns to her people after Naomi urges her to go.","Ruth chooses to remain with Naomi.","Ruth pledges to Naomi and to Naomi's God.","Naomi and Ruth arrive in Bethlehem at the beginning of the barley harvest."]},
2:{title:"Ruth meets Boaz",facts:["Ruth goes to glean in the fields.","The field belongs to Boaz, a relative of Elimelech.","Boaz asks who Ruth is.","Ruth is known for staying with Naomi.","Boaz tells Ruth to remain in his field.","Boaz orders his workers not to molest Ruth.","Boaz tells Ruth to drink from the water vessels.","Boaz invites Ruth to eat with the workers.","Boaz instructs workers to leave extra grain for Ruth.","Ruth returns to Naomi with grain and tells her about Boaz."]},
3:{title:"Ruth asks Boaz to redeem her",facts:["Naomi seeks security for Ruth.","Naomi tells Ruth to go to Boaz at the threshing floor.","Ruth follows Naomi's instructions.","Boaz is surprised to find Ruth at his feet during the night.","Ruth asks Boaz to spread his cloak over her.","Ruth identifies Boaz as a redeemer.","Boaz praises Ruth for her loyalty.","Boaz explains that a nearer redeemer exists.","Boaz promises to settle the matter the next day.","Ruth returns to Naomi with six measures of barley."]},
...
4:{title:"The Samaritan woman",facts:["Jesus travels through Samaria.","Jesus rests at Jacob's well.","A Samaritan woman comes to draw water.","Jesus asks the woman for a drink.","Jesus speaks about living water.","The woman has had five husbands.","Jesus identifies himself as the Messiah.","The woman leaves her water jar and tells people about Jesus.","Many Samaritans believe because of the woman's testimony.","Many more believe after hearing Jesus themselves."]},
5:{title:"Healing at Bethesda",facts:["Jesus goes to Jerusalem for a festival.","A pool called Bethesda has many sick people around it.","A man has been ill for thirty-eight years.","Jesus asks the man whether he wants to be made well.","Jesus tells the man to stand up, take his mat and walk.","The healing takes place on the Sabbath.","Some leaders object because the man carries his mat on the Sabbath.","Jesus speaks of God as his Father.","Jesus teaches about the resurrection and judgment.","John the Baptist is mentioned as a witness to Jesus."]},
6:{title:"Bread of Life",facts:["Jesus crosses the Sea of Galilee.","A large crowd follows Jesus because of signs of healing.","Jesus tests Philip about feeding the crowd.","A boy has five barley loaves and two fish.","Jesus gives thanks and distributes the food.","About five thousand men are fed.","Twelve baskets of leftovers are collected.","Jesus walks on the sea toward his disciples.","The crowd seeks Jesus after the feeding.","Jesus teaches that he is the bread of life."]},
